...
def salir():
    """
    Cerrar la ventana principal de la aplicacion
    """
    ventana.quit()
...
def mostrarAyuda():
    ...
    Muestra ayuda
    """
    messagebox.showinfo("Ayuda", "Esto es una calculadora simple que permite sumar/restar/multiplicar/dividir/potenciar")
 
def mostrarAyudaInfo():
    """
...
try:
    ...
    print(f"No se pudo cargar el icono desde ñla ruta: {Ruta_del_Logo}")
...
#Menu Calculadora
menu_calcu=tk.Menu(barra_menu, tearoff=0)
menu_calcu.add_command(label="Sumar", command=sumar)
menu_calcu.add_command(label="Restar", command=restar)
menu_calcu.add_command(label="Multiplicar", command=multi)
menu_calcu.add_command(label="Dividir", command=divi)
menu_calcu.add_command(label="Potenciacion", command=potencia)
barra_menu.add_cascade(label="Calculadora", menu=menu_calcu)
 
#Menu Ayuda
menu_ayuda=tk.Menu(barra_menu, tearoff=0)
menu_ayuda.add_command(label="Info", command=mostrarAyuda)
menu_ayuda.add_command(label="Acerca de", command=mostrarAyudaInfo)
barra_menu.add_cascade(label="Mostrar Ayuda", menu=menu_ayuda)
